...
public class CameraMovement : MonoBehaviour
{
    ...
    [SerializeField] bool showCameraLimits;
    ...
    public void SetCameraLimits(Vector2 lower, Vector2 upper)
    {
        lowerCameraLimit = lower;
        upperCameraLimit = upper;
    }
